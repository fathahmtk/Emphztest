    ...
    <div className="bg-white text-emphz-navy">
      ...
      <section className="bg-emphz-navy text-white py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h1 className="text-4xl md:text-7xl font-black mb-4 md:mb-6 max-w-3xl leading-tight">Engineering a Corrosion-Free Future.</h1>
          <p className="text-base md:text-xl text-gray-300 max-w-2xl leading-relaxed font-light border-l-4 border-emphz-orange pl-4 md:pl-6">
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="pr-0 md:pr-8">
            <h2 className="text-xs md:text-sm font-bold text-emphz-orange tracking-widest uppercase mb-3 md:mb-4">Our Mission</h2>
            <h3 className="text-3xl md:text-4xl font-bold text-emphz-navy mb-4 md:mb-6">To Replace Obsolete Materials.</h3>
          ...
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-200 space-y-6">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-bold text-base md:text-lg">Engineer for Environment</h4>
                <p className="text-gray-500 text-xs md:text-sm">Create products perfectly suited for their intended environment, from saline coasts to harsh industrial zones.</p>
              </div>
            </div>
            <div className="flex items-start">
              <div className="bg-emphz-orange/10 p-3 rounded-full mr-4"><Gem className="w-5 h-5 md:w-6 md:h-6 text-emphz-orange" /></div>
              <div>
                <h4 className="font-bold text-base md:text-lg">Deliver Unmatched Quality</h4>
                <p className="text-gray-500 text-xs md:text-sm">Utilize precision manufacturing and the highest-grade materials to deliver products that exceed international standards.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Our Values Section */}
       <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-xs md:text-sm font-bold text-emphz-orange tracking-widest uppercase mb-3 md:mb-4">Our Core Values</h2>
            <h3 className="text-3xl md:text-4xl font-bold text-emphz-navy mb-8 md:mb-12">The Principles That Guide Us.</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                {values.map((value, i) => (
                    <div key={i} className="bg-gray-50 p-6 md:p-8 rounded-xl border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                        {value.icon}
                        <h4 className="text-lg md:text-xl font-bold my-3 md:my-4">{value.title}</h4>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 md:mb-16">
                 <h2 className="text-xs md:text-sm font-bold text-emphz-orange tracking-widest uppercase mb-3 md:mb-4">Comparative Analysis</h2>
                 <h3 className="text-3xl md:text-4xl font-bold text-emphz-navy mb-4 md:mb-6">GRP vs. Traditional Materials: A Deeper Dive</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                ...
                <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
                    ...
                    <h4 className="font-bold text-base md:text-lg text-emphz-navy mb-3 md:mb-4">Corrosion</h4>
                    <div className="space-y-3">
                        <div className="flex items-start">
                            <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-green-500 mr-2 flex-shrink-0" />
                            <p className="text-xs md:text-sm text-gray-600"><span className="font-bold text-emphz-navy">GRP:</span> Chemically inert. 100% rust-proof in saline air.</p>
                        </div>
                        <div className="flex items-start">
                            <XCircle className="w-4 h-4 md:w-5 md:h-5 text-red-400 mr-2 flex-shrink-0" />
                            <p className="text-xs md:text-sm text-gray-600"><span className="font-bold text-emphz-navy">Steel:</span> Requires galvanizing or painting. Rusts inevitably.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
                    ...
                    <h4 className="font-bold text-base md:text-lg text-emphz-navy mb-3 md:mb-4">Electrical Safety</h4>
                    <div className="space-y-3">
                        <div className="flex items-start">
                            <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-green-500 mr-2 flex-shrink-0" />
                            <p className="text-xs md:text-sm text-gray-600"><span className="font-bold text-emphz-navy">GRP:</span> Natural insulator. Zero shock hazard.</p>
                        </div>
                        <div className="flex items-start">
                            <XCircle className="w-4 h-4 md:w-5 md:h-5 text-red-400 mr-2 flex-shrink-0" />
                            <p className="text-xs md:text-sm text-gray-600"><span className="font-bold text-emphz-navy">Metal:</span> Highly conductive. Dangerous if earthing fails.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
                    ...
                    <h4 className="font-bold text-base md:text-lg text-emphz-navy mb-3 md:mb-4">Weight & Install</h4>
                    <div className="space-y-3">
                        <div className="flex items-start">
                            <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-green-500 mr-2 flex-shrink-0" />
                            <p className="text-xs md:text-sm text-gray-600"><span className="font-bold text-emphz-navy">GRP:</span> Lightweight. Man-portable. Rapid assembly.</p>
                        </div>
                        <div className="flex items-start">
                            <XCircle className="w-4 h-4 md:w-5 md:h-5 text-red-400 mr-2 flex-shrink-0" />
                            <p className="text-xs md:text-sm text-gray-600"><span className="font-bold text-emphz-navy">Concrete:</span> Heavy. Requires cranes and heavy machinery.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
                    ...
                    <h4 className="font-bold text-base md:text-lg text-emphz-navy mb-3 md:mb-4">Maintenance</h4>
                    <div className="space-y-3">
                        <div className="flex items-start">
                            <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-green-500 mr-2 flex-shrink-0" />
                            <p className="text-xs md:text-sm text-gray-600"><span className="font-bold text-emphz-navy">GRP:</span> Fit and forget. UV stable. No painting needed.</p>
                        </div>
                        <div className="flex items-start">
                            <XCircle className="w-4 h-4 md:w-5 md:h-5 text-red-400 mr-2 flex-shrink-0" />
                            <p className="text-xs md:text-sm text-gray-600"><span className="font-bold text-emphz-navy">Others:</span> Regular re-painting and anti-rust treatments.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
               <div className="lg:w-1/2">
                   ...
                   <h3 className="text-3xl md:text-4xl font-bold text-emphz-navy mb-4 md:mb-6">Manufacturing Excellence.</h3>
                   ...
                   <div className="space-y-6 md:space-y-8 mt-6 md:mt-8">
                      <div className="flex gap-4">
                         ...
                         <div>
                            <h4 className="font-bold text-lg md:text-xl text-emphz-navy mb-1 md:mb-2">SMC Hot Press Molding</h4>
                      ...
                      <div className="flex gap-4">
                         ...
                         <div>
                            <h4 className="font-bold text-lg md:text-xl text-emphz-navy mb-1 md:mb-2">Pultrusion</h4>
                            <p className="text-xs md:text-sm text-gray-600">
                       ...
                       <div className="flex gap-4">
                         ...
                         <div>
                            <h4 className="font-bold text-lg md:text-xl text-emphz-navy mb-1 md:mb-2">Vacuum Infusion (RTM)</h4>
                            <p className="text-xs md:text-sm text-gray-600">
               ...
               <div className="lg:w-1/2 w-full">
                  <div className="grid grid-cols-2 gap-3 md:gap-4">
                     <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
                        ...
                        <div className="font-bold text-xl md:text-2xl text-emphz-navy">50,000+</div>
                        <div className="text-[10px] md:text-xs font-bold text-gray-500 uppercase tracking-widest mt-1">Sq. Ft. Factory</div>
                     </div>
                     <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
                        <Users className="w-8 h-8 md:w-12 md:h-12 text-gray-400 mb-3 md:mb-4" />
                        <div className="font-bold text-xl md:text-2xl text-emphz-navy">120+</div>
                        <div className="text-[10px] md:text-xs font-bold text-gray-500 uppercase tracking-widest mt-1">Skilled Technicians</div>
                     </div>
                     <div className="col-span-2 bg-emphz-navy text-white p-6 md:p-8 rounded-xl flex items-center justify-between">
                        <div>
                           <div className="font-bold text-xl md:text-2xl">ISO 9001:2015</div>
                           <div className="text-[10px] md:text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Certified Facility</div>
                        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                <div className="md:w-1/3 text-center md:text-left">
                    <h2 className="text-xs md:text-sm font-bold text-emphz-orange tracking-widest uppercase mb-3 md:mb-4">Strict Standards</h2>
                    <h3 className="text-3xl font-bold text-emphz-navy mb-3 md:mb-4">In-House QA Lab</h3>
                ...
                <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 w-full">
                     <div className="bg-gray-50 p-4 md:p-6 rounded-lg border border-gray-100">
                        ...
                        <h4 className="font-bold text-emphz-navy text-sm mb-1 md:mb-2">Hydrostatic Pressure</h4>
                        <p className="text-[10px] md:text-xs text-gray-500">Testing water tanks and enclosures for leaks under high pressure loads.</p>
                     </div>
                     <div className="bg-gray-50 p-4 md:p-6 rounded-lg border border-gray-100">
                        <Sun className="w-6 h-6 md:w-8 md:h-8 text-emphz-navy mb-2 md:mb-3" />
                        <h4 className="font-bold text-emphz-navy text-sm mb-1 md:mb-2">UV Aging Chamber</h4>
                        <p className="text-[10px] md:text-xs text-gray-500">Simulating years of solar exposure to ensure color stability and structural integrity.</p>
                     </div>
                     <div className="bg-gray-50 p-4 md:p-6 rounded-lg border border-gray-100">
                        <Hammer className="w-6 h-6 md:w-8 md:h-8 text-emphz-navy mb-2 md:mb-3" />
                        <h4 className="font-bold text-emphz-navy text-sm mb-1 md:mb-2">Impact Testing</h4>
                        <p className="text-[10px] md:text-xs text-gray-500">Drop tests to verify IK10 impact resistance ratings for heavy-duty enclosures.</p>
                     </div>
                </div>
            </div>
        </div>
      ...
      {/* NEW: Sustainability Section */}
       <section className="py-16 md:py-20 bg-green-50">
        <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <h2 className="text-3xl font-bold text-emphz-navy mb-3 md:mb-4">Sustainable Infrastructure</h2>
            <p className="text-base md:text-lg text-gray-600 mb-6 md:mb-8 font-light">
            ...
            <div className="inline-flex items-center bg-white px-5 py-2 md:px-6 md:py-3 rounded-full shadow-sm border border-green-200 text-green-700 font-bold text-xs md:text-sm">
      ...
      <section className="py-16 md:py-20 bg-emphz-cream">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 md:mb-16">
                 <h2 className="text-xs md:text-sm font-bold text-emphz-orange tracking-widest uppercase mb-3 md:mb-4">Our Journey</h2>
                 <h3 className="text-3xl md:text-4xl font-bold text-emphz-navy">From Concept to Coastline.</h3>
            </div>
            <div className="relative">
                 {/* The vertical line */}
                <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-0.5 bg-emphz-orange/20 hidden md:block"></div>
                {timelineEvents.map((event, i) => (
                    <div key={i} className={`mb-8 md:mb-12 flex items-center w-full ${i % 2 === 0 ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
                        ...
                        <div className={`bg-white p-6 rounded-xl shadow-lg border border-gray-200 w-full md:w-5/12 ${i % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                            <div className="md:hidden w-10 h-10 bg-emphz-navy rounded-full shadow-lg flex items-center justify-center text-white mb-4">
                                {event.icon}
                            </div>
                            <p className="text-emphz-orange font-black text-xl md:text-2xl mb-1 md:mb-2">{event.year}</p>
                            <h4 className="font-bold text-base md:text-lg mb-1 md:mb-2">{event.title}</h4>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-xs md:text-sm font-bold text-emphz-orange tracking-widest uppercase mb-3 md:mb-4">Our Experts</h2>
            <h3 className="text-3xl md:text-4xl font-bold text-emphz-navy mb-6">The Minds Behind the Material.</h3>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                ...
                <div className="text-center group">
                    <div className="relative w-28 h-28 md:w-40 md:h-40 mx-auto rounded-full overflow-hidden border-4 border-gray-100 group-hover:border-emphz-orange transition-colors">
                        <img src="https://picsum.photos/200/200?random=40" alt="Team member" className="w-full h-full object-cover"/>
                    </div>
                    <h4 className="font-bold text-base md:text-lg mt-3 md:mt-4">Rajesh Nair</h4>
                    <p className="text-emphz-orange text-xs md:text-sm font-medium">Founder & Chief Engineer</p>
                </div>
                <div className="text-center group">
                    <div className="relative w-28 h-28 md:w-40 md:h-40 mx-auto rounded-full overflow-hidden border-4 border-gray-100 group-hover:border-emphz-orange transition-colors">
                        <img src="https://picsum.photos/200/200?random=41" alt="Team member" className="w-full h-full object-cover"/>
                    </div>
                    <h4 className="font-bold text-base md:text-lg mt-3 md:mt-4">Anjali Kumar</h4>
                    <p className="text-emphz-orange text-xs md:text-sm font-medium">Head of Operations</p>
                </div>
                <div className="text-center group">
                    <div className="relative w-28 h-28 md:w-40 md:h-40 mx-auto rounded-full overflow-hidden border-4 border-gray-100 group-hover:border-emphz-orange transition-colors">
                        <img src="https://picsum.photos/200/200?random=42" alt="Team member" className="w-full h-full object-cover"/>
                    </div>
                    <h4 className="font-bold text-base md:text-lg mt-3 md:mt-4">Vikram Singh</h4>
                    <p className="text-emphz-orange text-xs md:text-sm font-medium">Lead, Material Science</p>
                </div>
                <div className="text-center group">
                    <div className="relative w-28 h-28 md:w-40 md:h-40 mx-auto rounded-full overflow-hidden border-4 border-gray-100 group-hover:border-emphz-orange transition-colors">
                        <img src="https://picsum.photos/200/200?random=43" alt="Team member" className="w-full h-full object-cover"/>
                    </div>
                    <h4 className="font-bold text-base md:text-lg mt-3 md:mt-4">Priya Menon</h4>
                    <p className="text-emphz-orange text-xs md:text-sm font-medium">Project Management</p>
                </div>
            </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-gray-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-10 md:mb-12 text-center">
                 <h2 className="text-xs md:text-sm font-bold text-emphz-orange tracking-widest uppercase mb-3 md:mb-4">Peace of Mind</h2>
                 <h3 className="text-3xl md:text-4xl font-bold text-emphz-navy">Industry-Leading Warranty.</h3>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
                <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-100 flex flex-col items-center text-center transform hover:-translate-y-1 transition-transform">
                    ...
                    <h4 className="font-bold text-base md:text-lg mb-2 md:mb-3">10-Year Structural Warranty</h4>
                ...
                <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-100 flex flex-col items-center text-center transform hover:-translate-y-1 transition-transform">
                    ...
                    <h4 className="font-bold text-base md:text-lg mb-2 md:mb-3">Coverage Details</h4>
                    <p className="text-gray-600 text-xs md:text-sm leading-relaxed">
                ...
                <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-100 flex flex-col items-center text-center transform hover:-translate-y-1 transition-transform">
                    ...
                    <h4 className="font-bold text-base md:text-lg mb-2 md:mb-3">Seamless Claims</h4>
                    <p className="text-gray-600 text-xs md:text-sm leading-relaxed">
      ...
      {/* CTA Section */}
       <section className="bg-emphz-navy">
            <div className="max-w-5xl mx-auto px-4 py-16 md:py-20 text-center">
                <h2 className="text-3xl md:text-4xl font-black text-white mb-4 md:mb-6">Ready to Build with Confidence?</h2>
